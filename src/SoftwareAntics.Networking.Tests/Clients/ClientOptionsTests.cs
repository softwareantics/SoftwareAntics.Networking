...
public sealed class ClientOptionsTests
{
    ...
    {
        // Act and assert
        Assert.That(this.options.GetType().GetProperty(nameof(ClientOptions.Address)).GetCustomAttribute<RequiredAttribute>(), Is.Not.Null);
    }
    ...
    {
        // Arrange
        var range = this.options.GetType().GetProperty(nameof(ClientOptions.Port)).GetCustomAttribute<RangeAttribute>();
    ...
    {
        // Act and assert
        Assert.That(this.options.GetType().GetProperty(nameof(ClientOptions.Port)).GetCustomAttribute<RangeAttribute>(), Is.Not.Null);
    }
    ...
    {
        // Act and assert
        Assert.That(this.options.GetType().GetProperty(nameof(ClientOptions.Port)).GetCustomAttribute<RequiredAttribute>(), Is.Not.Null);
    }
